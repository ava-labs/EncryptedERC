...
exports.default = () => ({
    ...
    blockchain: {
        avadbRpcUrl: process.env.AVADB_RPC_URL ??
        ...
        avalancheChainId: parseInt(process.env.AVALANCHE_CHAIN_ID ?? '43114', 10),
        replicatorPrivateKey: process.env.REPLICATOR_PRIVATE_KEY ?? '',
        avadbStorageAddress: process.env.AVADB_STORAGE_ADDRESS ??
